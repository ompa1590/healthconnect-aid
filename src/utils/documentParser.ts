...
export const parsePdfContent = async (file: File): Promise<string> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      } else if (documentType.includes('xray') || documentType.includes('imaging')) {
      ...
      } else if (documentType.includes('mri')) {
      ...
      } else if (documentType.includes('med') || documentType.includes('prescription')) {
