...
import { Accessibility, Lightbulb, Users, Heart, Clock, Award, Shield, Sparkles, ArrowRight } from "lucide-react";
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="container mx-auto px-6 mb-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold mb-6 md:text-5xl">Transforming Healthcare for the Digital Age</h1>
                  ...
                  <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 w-3/4 h-3/4">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-32 h-32 rounded-full border-4 border-primary/50 animate-pulse" style={{
        ...
        <section className="container mx-auto px-6 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((value, index) => <GlassCard key={index} className="p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in" style={{
        ...
        <section className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {benefits.map((benefit, index) => <GlassCard key={index} className="p-6 animate-fade-in" style={{
            animationDelay: `${index * 0.1}s`
          }}>
