      ...
      <main className="pt-32 pb-20">
        <section className="container mx-auto px-6">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            {steps.map((step, index) => <div key={step.id} className={`relative mb-20 lg:mb-32 ${index % 2 === 0 ? 'lg:pr-16' : 'lg:pl-16'} animate-fade-in`} style={{
            animationDelay: `${index * 0.2}s`
                ...
                <div className={`lg:flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  ...
                  <GlassCard className={`w-full lg:w-1/2 p-8 hover:shadow-lg transition-all duration-300 ${index % 2 === 0 ? '' : ''}`}>
                  ...
                  <div className={`hidden lg:block w-1/2 ${index % 2 === 0 ? 'pl-16' : 'pr-16'}`}>
                    <div className={`${index % 2 === 0 ? 'float-animation-slow' : 'float-animation'} relative`}>
                      ...
                      <div className={`absolute bottom-1/4 ${index % 2 === 0 ? 'left-20' : 'right-20'} w-12 h-12 rounded-full bg-${index % 2 === 0 ? 'secondary' : 'primary'}/20 floating`} style={{
                    animationDelay: "0.5s"
                  }}></div>
                    </div>
                  </div>
