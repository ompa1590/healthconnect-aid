...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-20 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-1/3 right-0 w-72 h-72 bg-primary/10 rounded-full filter blur-3xl -z-10"></div>
      <div className="absolute bottom-1/3 left-0 w-72 h-72 bg-secondary/10 rounded-full filter blur-3xl -z-10"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <Button
                variant="ghost"
                className="mt-6 p-0 h-auto text-primary hover:text-primary/80 hover:bg-transparent justify-start"
                asChild
              >
                <Link to="#">
