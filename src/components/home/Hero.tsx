...
const Hero = () => {
  ...
  return <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          animationDelay: "0.2s"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="rounded-full text-base font-medium px-8 bg-primary hover:bg-primary/90" asChild>
                <Link to="/signup">
                  Get Started
          ...
          animationDelay: "0.4s"
            ...
            <div className="absolute top-1/3 -right-8 w-16 h-16 bg-secondary/20 rounded-full floating" style={{
            animationDelay: "1s"
          }}></div>
            <div className="absolute -bottom-8 left-1/4 w-24 h-24 bg-primary/10 rounded-full floating-slow" style={{
            animationDelay: "0.5s"
          }}></div>
      ...
      <div className="absolute bottom-1/4 left-10 w-16 h-16 bg-secondary/20 rounded-full flex items-center justify-center floating" style={{
      animationDelay: "1.5s"
    }}>
